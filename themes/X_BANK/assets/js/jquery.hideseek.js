...
;(function($, window, undefined) {
  ...
  $.fn.hideseek = function(options) {
    ...
    return this.each(function() {
      ...
      if ($this.opts.hidden_mode) $list.find(".index_results").siblings().hide();
      ...
      $this.keyup(function(e) {
        ...
        if (e.keyCode != 38 && e.keyCode != 40 && e.keyCode != 13) {
          ...
          $list.children($this.opts.ignore.trim() ? ":not(" + $this.opts.ignore + ")" : '').removeClass('selected').each(function() {
            ...
            var data = ($this.opts.attribute != 'text') ? $(this).attr($this.opts.attribute).toLowerCase() : $(this).find(".index_artist_title").text().toLowerCase();
            // console.log(data);
