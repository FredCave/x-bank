<section id="index" class="index" data-cat="">
	...
	<div class="section_content">
		...
		<ul id="index_categories" class="">
			<li><a href="" data-slug="fashion">Fashion</a></li>
			<li><a href="" data-slug="art">Art</a></li>
			<li><a href="" data-slug="design">Design</a></li>
			<div class="clear"></div>
		</ul>
		...
		<div id="sub_cat_wrapper" class="">
			<ul id="fashion_sub_cat" class="sub_cat">
				...
				foreach($categories as $category) { 		
					echo "<li><a href='' data-slug='" . $category->slug . "'>". $category->name ."</a></li>";
					if ( $loop === 3 ) {
						echo "</span><span>";
						$loop = 0;
					}
